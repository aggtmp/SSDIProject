...
try
	{
		...
		{
%>
		Question No.<%=rs1.getString("qn") %>:<br> Question:<%=rs1.getString("q") %><br>
		<br> <input type=radio name=1 value=1><%=rs1.getString("o1") %><br>
		<input type=radio name=1 value=2><%=rs1.getString("o2") %><br>
		<input type=radio name=1 value=3><%=rs1.getString("o3") %><br>
		<input type=radio name=1 value=4><%=rs1.getString("o4") %><br>
		<br>
		<br>
		-------------------------------------------------------------- <br>
		<br>
		...
		{
%>
		Question No.<%=rs2.getString("qn") %>:<br> Question:<%=rs2.getString("q") %><br>
		<br> <input type=radio name=2 value=1><%=rs2.getString("o1") %><br>
		<input type=radio name=2 value=2><%=rs2.getString("o2") %><br>
		<input type=radio name=2 value=3><%=rs2.getString("o3") %><br>
		<input type=radio name=2 value=4><%=rs2.getString("o4") %><br>
		<br>
		<br>
		-------------------------------------------------------------- <br>
		<br>
		...
		{
%>
		Question No.<%=rs3.getString("qn") %>:<br> Question:<%=rs3.getString("q") %><br>
		<br> <input type=radio name=3 value=1><%=rs3.getString("o1") %><br>
		<input type=radio name=3 value=2><%=rs3.getString("o2") %><br>
		<input type=radio name=3 value=3><%=rs3.getString("o3") %><br>
		<input type=radio name=3 value=4><%=rs3.getString("o4") %><br>
		<br>
		<br>
		--------------------------------------------------------------<br>
		<br>
		...
		{
%>
		Question No.<%=rs4.getString("qn") %>:<br> Question:<%=rs4.getString("q") %><br>
		<br> <input type=radio name=4 value=1><%=rs4.getString("o1") %><br>
		<input type=radio name=4 value=2><%=rs4.getString("o2") %><br>
		<input type=radio name=4 value=3><%=rs4.getString("o3") %><br>
		<input type=radio name=4 value=4><%=rs4.getString("o4") %><br>
		<br>
		<br>
		--------------------------------------------------------------<br>
		<br>
		...
		{
%>
		Question No.<%=rs5.getString("qn") %>:<br> Question:<%=rs5.getString("q") %><br>
		<br> <input type=radio name=5 value=1><%=rs5.getString("o1") %><br>
		<input type=radio name=5 value=2><%=rs5.getString("o2") %><br>
		<input type=radio name=5 value=3><%=rs5.getString("o3") %><br>
		<input type=radio name=5 value=4><%=rs5.getString("o4") %><br>
		<br>
		<br>
		--------------------------------------------------------------<br>
